...
def process(graf, derajat, rencana_kuliah) :
    # memasukkan mata kuliah yang bisa diambil pada satu semester (mata kuliah yang memiliki derajat = 0) 
    # ke dalam rencana kuliah
    matkul_sem = []
    ...
    # menghilangkan node mata kuliah yang bisa diambil beserta menghilangkan relasi suksesor 
    # ke node yang dihilangkan dari graf
